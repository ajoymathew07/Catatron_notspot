...
This repository contains all the files and code needed to simulate the notspot quadrupled robot using [Gazebo](http://gazebosim.org/)  and [ROS](https://www.ros.org/).
